				...
				<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width: 100%;">
					<thead>
						<tr>
							...
							<th>Sumber Air yang digunakan</th>
							<th>Pengelola Air</th>	
							<th>Aksi</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td>
								...
								<a href="<?php echo site_url('main/viewdatarum'); ?>"><button class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span></button></a>
							</td>
						</tr>
					</tbody>
				</table>
