...
class M_back extends CI_Model {
	...
	public function proses_input()
	{
		...
		$total_minggu1 = $this->input->post('totalminggu2');
		...
		$datapeng = $this->db->insert('data_teknis', array(
			...
			'peng_bangunan'=>$senin1.','.$senin2.','.$selasa1.','.$selasa2.','.$rabu1.','.$rabu2.','.$kamis1.','.$kamis2.','.$jumat1.','.$jumat2.','.$sabtu1.','.$sabtu2.','.$minggu1.','.$minggu2.','.$total_minggu.','.$total_minggu1,
	...
	/// EDIT DATANYA AWAS NAMENYA SAMA WKOWKOWKOWKOWKO
